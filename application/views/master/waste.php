            ...
            <div class="row">
                <div class="col align-self-center p-5">
                    <h3 class="text-dark-grey m-0">
                        <b class="small">Waste Settings</b>
                    </h3>
                    <p class="super-small-text m-0 text-light-dark-grey">Pengaturan Waste</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card shadow-none border-0">
                        <div class="card-body p-0">
                            <div class="row justify-content-between p-4 pt-1" style="margin-bottom: 8px;">
                                <div class="col-12">
                                    <p class="m-0 small-text">Waste Setting</p>
                                    <h3 class="m-0"><b>ABOF 20</b> > <b>MAKER</b></h3>
                                </div>
                            </div>
                            <div class="row justify-content-between p-4 pt-1" style="margin-bottom: 8px;">
                                <div class="col-4">
                                    <div class="card shadow-none h-100">
                                        ...
                                        <div class="card-body">
                                            <button class="btn btn-outline-primary w-100 mb-2" style="border-style: dotted;border-width:2px;"><i class="fa fa-plus me-2"></i>Tambah Waste</button>
                                            <div class="card shadow-sm mb-2 pointer card-hoper">
                                                <div class="card-body">
                                                    Alval Panjang <span class="badge bg-primary">2</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
