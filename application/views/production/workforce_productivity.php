...
<main>
    <div class="row">
        <!-- LEFT PANEL -->
        <div class="col-3 bg-left-panel full-height p-5 pt-2 pe-1">
            <div class="row p-3">
                <div class="col align-self-center p-0">
                    <p class="text-dark-grey m-0 small">
                        <b>SKM Production</b>
                    </p>
                    <p class="small-text m-0 text-light-dark-grey">4 Active Machine</p>
                </div>
        ...
        <div class="col-9 bg-white p-4">
            <div class="row">
                <div class="col-1 align-self-center">
                    <img class="w-100" src="<?= base_url() ?>assets/image/svg/factory2.svg" alt="Icon" />
                </div>
                <div class="col-auto align-self-center">
                    <h1 class="m-0"><b>Production Pane</b></h1>
            ...
            <div class="row pt-4">
                <div class="col-auto align-self-center" id="statusLine">
                    <div class="row p-3">
                        ...
                        <div class="col-auto statusLine text-small pb-2 align-self-center fw-bold text-grey" style="cursor:pointer" onclick="statusLine()" id="colStatusLineall">
                            Work Machine
                        </div>
                        <div class="col-auto statusLine text-small pb-2 align-self-center fw-bold text-grey" style="cursor:pointer" onclick="statusLine()" id="colStatusLineall">
                            Material Usage
