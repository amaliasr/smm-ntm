...
<script>
    ...
    function listPlan() {
        var html = ""
        $.each(data_plan, function(keys, values) {
            html += '<div class="row">'
            html += '<div class="col-12">'
            html += '<div class="card shadow-none mb-2">'
            html += '<div class="card-body p-0">'
            html += '<div class="row p-0 m-0">'
            html += '<div class="col-1 p-3 rounded-start bg-' + JSON.parse(values['production_type'])['name'].toLowerCase() + ' text-center">'
            html += '<div class="row d-flex align-items-center h-100">'
            html += '<div class="col text-center">'
            html += '<span class="small text-white vertical-text">' + JSON.parse(values['production_type'])['name'] + '</span>'
            html += '</div>'
            html += '</div>'
            html += '</div>'
            ...
            html += '<p class="m-0"><i class="fa fa-check-circle text-grey me-2"></i> Created</p>'
            html += '</div>'
            html += '<div class="col-auto">'
            html += '<p class="m-0"><i class="fa fa-check-circle text-grey me-2"></i> Drafted</p>'
            html += '</div>'
            html += '<div class="col-auto">'
            html += '<p class="m-0"><i class="fa fa-check-circle text-grey me-2"></i> Done</p>'
            html += '</div>'
            html += '</div>'
            html += '</div>'
