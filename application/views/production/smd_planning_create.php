                                            ...
                                            <div class="col-12">
                                                <nav>
                                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                        <button style="width: 100px;" class="p-3 nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">SKM</button>
                                                        <button style="width: 100px;" class="p-3 nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">SKT</button>
                                                    </div>
                                                </nav>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-12 col-md-4">
                                                                            <p class="m-0" style="font-size: 12px;"><b>Date Range</b></p>
                                                                            <input type="text" class="form-control form-control-sm litepicker" required="required" id="dateRange">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
