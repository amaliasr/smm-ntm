	...
	!(function ($) {
		...
		(H.VERSION = "1.14.0-beta3"),
			(H.DEFAULTS = {
				...
				noneResultsText: "Data tidak ditemukan {0}",
				countSelectedText: function (e, t) {
					return 1 == e ? "{0} item terpilih" : "{0} items terpilih";
				},
				...
				multipleSeparator: ", ",
				styleBase:
					"form-control form-control-solid form-control-sm is-select-picker",
				style: T.BUTTONCLASS,
				size: "auto",
				title: null,
				placeholder: null,
			...
			(H.prototype = {
					...
					ee++,
						...
						t.hasAttribute("required") &&
							this.$element.on("invalid" + A, function () {
								i.$button[0].classList.add("is-invalid"),
									i.$element
										...
										.on("rendered" + A, function () {
											this.validity.valid &&
												i.$button[0].classList.remove("is-invalid"),
				...
				createDropdown: function () {
					...
					return (
						...
						this.options.liveSearch &&
							(o =
								'<div class="bs-searchbox"><input type="search" class="form-control form-control-solid form-control-sm mb-3" autocomplete="off"' +
