	...
	return (
			...
			t.validator.addMethod(
				...
				t.validator.addMethod(
					...
					function (t, a, d) {
						...
						return (
							this.optional(a) ||
							(r.match(i).length >= d[0] && r.match(i).length <= d[1])
						);
					},
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				var r,
					i,
					n = "string" == typeof d ? d.replace(/\s/g, "") : "image/*",
					o = this.optional(a);
				if (o) return o;
				if (
					"file" === t(a).attr("type") &&
					...
					for (
						i = new RegExp(".?(" + n + ")$", "i"), r = 0;
						r < a.files.length;
						r++
					)
						if (!a.files[r].type.match(i)) return !1;
				return !0;
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				...
				var a,
					...
					r = 0,
					i = d.length;
				for (a = 0; a < i; a++) r += (i - a) * d.substring(a, a + 1);
				return r % 11 == 0;
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				...
				var d,
					...
					f = 0,
					h = 0;
				if (9 !== t.length || !o.test(t)) return !1;
				for (d = 0; d < l.length; d++)
					(r = parseInt(l[d], 10)),
						a(d) ? (h += (r *= 2) < 10 ? r : r - 9) : (f += r);
				return (
					(i = (10 - (f + h).toString().substr(-1)).toString()),
					(i = parseInt(i, 10) > 9 ? "0" : i),
					(n = "JABCDEFGHI".substr(i, 1).toString()),
					s.match(/[ABEH]/)
						? u === i
						: s.match(/[KPQS]/)
						? u === n
		...
		t.validator.addMethod(
			...
			function (t) {
				...
				for (r = 0, i = 9, 0; r < 9; ++r, --i) n += +t.charAt(r) * i;
				for (
					(a = n % 11) >= 10 && ((a = 0), (o = 2)), n = 0, r = 0, i = 1, 0;
					r < 9;
					++r, ++i
				)
					n += +t.charAt(r) * i;
		...
		t.validator.addMethod(
			...
			function (t, e) {
				...
				for (
					...
					(i += d.charAt(a - o) * n--), n < 2 && (n = 9);
				var s = i % 11 < 2 ? 0 : 11 - (i % 11);
				if (s !== parseInt(r.charAt(0), 10)) return !1;
				(a += 1), (d = t.substring(0, a)), (i = 0), (n = a - 7);
				for (var l = a; l >= 1; l--)
					(i += d.charAt(a - l) * n--), n < 2 && (n = 9);
				return (
					(s = i % 11 < 2 ? 0 : 11 - (i % 11)) === parseInt(r.charAt(1), 10)
				);
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				...
				if (
					...
					(d = parseInt(t.substring(10, 11), 10)),
					(r = function (t, e) {
						var a = (10 * t) % 11;
		...
		t.validator.addMethod(
			...
			function (t, e, a) {
				...
				return (
					...
					a.unknown && (d |= 128),
					a.all && (d = 255),
					(1 & d && (/^(5[12345])/.test(t) || /^(2[234567])/.test(t))) ||
					(2 & d && /^(4)/.test(t))
						? 16 === t.length
						: 4 & d && /^(3[47])/.test(t)
						? 15 === t.length
						: 8 & d && /^(3(0[012345]|[68]))/.test(t)
						? 14 === t.length
						: 16 & d && /^(2(014|149))/.test(t)
						? 15 === t.length
						: (32 & d && /^(6011)/.test(t)) || (64 & d && /^(3)/.test(t))
						? 16 === t.length
						: 64 & d && /^(2131|1800)/.test(t)
						? 15 === t.length
						: !!(128 & d)
				);
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				...
				if (
					...
					return !1;
				for (
					a = o.substring(4, o.length) + o.substring(0, 4), i = 0;
					i < a.length;
					i++
				)
					"0" !== (d = a.charAt(i)) && (l = !1),
						l || (s += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(d));
				for (n = 0; n < s.length; n++) u = ("" + u + s.charAt(n)) % 97;
				return 1 === u;
			},
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				return (
					!!this.optional(a) ||
					!("file" === t(a).attr("type") && a.files && a.files.length > d)
				);
			},
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				if (this.optional(a)) return !0;
				if ("file" === t(a).attr("type") && a.files && a.files.length)
					for (var r = 0, i = 0; i < a.files.length; i++)
						if ((r += a.files[i].size) > d) return !1;
				return !0;
			},
				...
				return (
					...
					((a =
						...
						(t = t
							...
							? t.substr(0, 8)
							: t.substr(0, 9)),
					"TRWAGMYFPDXBNJZSQVHLCKET".charAt(parseInt(a, 10) % 23) === r)
				);
			},
			...
			function (t, e) {
				...
				return (
					...
					(!!(t = t.toUpperCase()).match(
						...
						(/^[0-9]{8}[A-Z]{1}$/.test(t)
							? "TRWAGMYFPDXBNJZSQVHLCKE".charAt(t.substring(8, 0) % 23) ===
							  t.charAt(8)
							: !!/^[KLM]{1}/.test(t) &&
							  t[8] ===
									"TRWAGMYFPDXBNJZSQVHLCKE".charAt(t.substring(8, 1) % 23)))
				);
			},
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				return (
					this.optional(a) || !t.validator.methods.equalTo.call(this, e, a, d)
				);
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				return (
					this.optional(e) || /^\d{2}.\d{3}-\d{3}?$|^\d{5}-?\d{3}?$/.test(t)
				);
			},
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				var r = t(d[1], a.form),
					i = r.eq(0),
					n = i.data("valid_req_grp")
						? i.data("valid_req_grp")
						: t.extend({}, this),
					o =
						r.filter(function () {
		...
		t.validator.addMethod(
			...
			function (e, a, d) {
				var r = t(d[1], a.form),
					i = r.eq(0),
					n = i.data("valid_skip") ? i.data("valid_skip") : t.extend({}, this),
					o = r.filter(function () {
						return n.elementValue(this);
					}).length,
					s = 0 === o || o >= d[0];
		...
		t.validator.addMethod(
			...
			function (t, e, a) {
				var d,
					r = void 0 === a,
					i = !r && void 0 !== a.caseSensitive && a.caseSensitive,
				...
				return (
					...
					(d = i ? new RegExp(d) : new RegExp(d, "i")),
					this.optional(e) || d.test(t)
				);
			},
		...
		t.validator.addMethod(
			...
			function (t, e) {
				return (
					this.optional(e) || /^([01]\d|2[0-3]|[0-9])(:[0-5]\d){1,2}$/.test(t)
				);
			},
		...
		t.validator.addMethod(
			...
			function (t) {
				...
				for (e = 0; e < 17; e++) {
					if (
						((r = l[e]), (d = t.slice(e, e + 1)), 8 === e && (n = d), isNaN(d))
					) {
						for (a = 0; a < o.length; a++)
							if (d.toUpperCase() === o[a]) {
								(d = s[a]), (d *= r), isNaN(n) && 8 === a && (n = o[a]);
								break;
							}
					} else d *= r;
					u += d;
				}
				return 10 === (i = u % 11) && (i = "X"), i === n;
			},
