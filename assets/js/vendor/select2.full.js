							...
							(s = function (e, t) {
								...
								(o = function (e, t, n, i) {
									...
									if (
										...
										(u = n ? n.apply(l[e], _) : void 0),
											e &&
												(o && void 0 !== o.exports && o.exports !== l[e]
													? (l[e] = o.exports)
													: (void 0 === u && m) || (l[e] = u));
									} else e && (l[e] = n);
								}),
									...
									this.on("keypress", function (t) {
										...
										e.isOpen()
											? n === i.ESC || n === i.TAB || (n === i.UP && t.altKey)
												...
												: n === i.ENTER
												? (e.trigger("results:select", e.close()),
												  t.preventDefault())
												: n === i.SPACE && t.ctrlKey
